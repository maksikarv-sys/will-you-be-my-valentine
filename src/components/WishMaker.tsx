...
const WishMaker = ({ onBack }: WishMakerProps) => {
  ...
  const wishes = [
    ...
    "To have countless cherry tomatoes pasta and coffee lessons with you",
    "To support each other through every challenge",
    "To grow old together with hearts forever young",
    "To make our partners accept their fate as third wheelers",,
    "To celebrate every little victory with you",
    "To be your greatest adventure",
    "To create a found family that grows into one thicker than blood",
    "To watch our kids fall in love with tinker bell and rapunzel as we did", 
